...
- Access to the GCP project (e.g., `rle-ruritania-yzyz`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-yzyz" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-yzyz.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-yzyz --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-yzyz.iam.gserviceaccount.com" \
  --project="rle-ruritania-yzyz" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-yzyz.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-yzyz.
